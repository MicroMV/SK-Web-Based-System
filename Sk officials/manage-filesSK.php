...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_file'])) {
    ...
    if ($current_file) {
        ...
        header("Location: manage-filesSK.php?success=File updated successfully");
        exit;
    }
}
                    ...
                    <?php foreach ($files_by_category['Budget'] as $file): ?>
                        <div class="file-card">
                            ...
                            <div class="file-actions">
                                <a href="downloadSK.php?id=<?= $file['file_id'] ?>" class="file-btn download">
                                    <i class="fas fa-download"></i> Download
                                </a>
                                <a href="manage-filesSK.php?edit=<?= $file['file_id'] ?>" class="file-btn edit">Edit</a>
    ...
    <div class="modal" id="editModal" style="display: block;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="close-btn" onclick="window.location.href='manage-filesSK.php'">&times;</button>
            </div>
            
            <form method="POST" action="manage-filesSK.php">
