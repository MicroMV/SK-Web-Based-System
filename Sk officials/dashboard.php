    ...
    <main class="admin-main">
        ...
        <section class="dashboard-stats">
            ...
            <div class="stats-grid">
                <a href="view-profilesSK.php" style="text-decoration: none;">
                    <div class="stat-card">
                ...
                <a href="manage-announcementsSK.php" style="text-decoration: none;">
                    <div class="stat-card">
                ...
                <a href="manage-achievementsSK.php" style="text-decoration: none;">
                    <div class="stat-card">
                ...
                <a href="inventorySK.php" style="text-decoration: none;">
                    <div class="stat-card">
        ...
        <section class="quick-actions">
            ...
            <div class="actions-grid">
                <a href="manage-announcementsSK.php?action=create" class="action-btn">
                    <i class="fas fa-plus-circle"></i>
                    <span>New Announcement</span>
                </a>
                <a href="manage-achievementsSK.php?action=create" class="action-btn">
                    <i class="fas fa-award"></i>
                    <span>Add Achievement</span>
                </a>
                <a href="inventorySK.php?action=create" class="action-btn">
                    <i class="fas fa-box"></i>
                    <span>Add Inventory</span>
                </a>
                <a href="manage-filesSK.php" class="action-btn">
                    ...
                    <?php if (!empty($recentAnnouncements)): ?>
                        <?php foreach ($recentAnnouncements as $announcement): ?>
                            <div class="list-item">
                                ...
                                <a href="manage-announcementsSK.php?id=<?php echo $announcement['announcement_id']; ?>" class="item-action">
                    ...
                    <?php if (!empty($recentAchievements)): ?>
                        <?php foreach ($recentAchievements as $achievement): ?>
                            <div class="list-item">
                                ...
                                <a href="manage-achievementsSK.php?id=<?php echo $achievement['achievement_id']; ?>" class="item-action">
                                    <i class="fas fa-edit"></i>
                                </a>
                            </div>
                        <?php endforeach; ?>
                ...
                <div class="items-list">
                    <?php foreach ($lowStockItems as $item): ?>
                        <div class="list-item alert-item">
                            ...
                            <a href="inventorySK.php?id=<?php echo $item['inventory_id']; ?>" class="item-action">
                                <i class="fas fa-edit"></i>
                            </a>
                        </div>
                    <?php endforeach; ?>
