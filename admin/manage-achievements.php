...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($title) > 200) {
        header("Location: manage-achievements.php?error=Title too long");
        exit;
    }
    if (strlen($description) > 5000) {
        header("Location: manage-achievements.php?error=Description too long");
        exit;
    }
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        if ($_FILES['image']['size'] > 5242880) {
            header("Location: manage-achievements.php?error=Image too large (max 5MB)");
            exit;
        }
        ...
        if (!in_array($_FILES['image']['type'], $allowedTypes)) {
            header("Location: manage-achievements.php?error=Invalid image type");
            exit;
        }
    ...
    if ($achievement_id) {
        ...
        if (empty($image_path)) {
            header("Location: manage-achievements.php?error=Image is required for new achievements");
            exit;
        }
    ...
    header("Location: manage-achievements.php?success=1");
    exit;
}
...
if (isset($_GET['delete'])) {
    ...
    header("Location: manage-achievements.php?deleted=1");
    exit;
}
...
<head>
    ...
    <link rel="stylesheet" href="manage_achievements.css">
    ...
    <header class="admin-header">
        ...
        <nav>
            <ul class="navigation" id="navigation">
                ...
                <li><a href="manage-achievements.php" class="active"><i class="fas fa-trophy"></i> Achievements</a></li>
