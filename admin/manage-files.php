...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['file'])) {
    ...
    if ($file_size > 10485760) {
        header("Location: manage-files.php?error=File too large (max 10MB)");
        exit;
    }
    ...
    if (!in_array($file_type, $allowed_types)) {
        header("Location: manage-files.php?error=Invalid file type");
        exit;
    }
    ...
    if (move_uploaded_file($file_tmp, $file_path)) {
        ...
        header("Location: manage-files.php?success=1");
        exit;
    } else {
        header("Location: manage-files.php?error=Upload failed");
        exit;
    }
}
...
if (isset($_GET['delete'])) {
    ...
    header("Location: manage-files.php?deleted=1");
    exit;
}
    ...
    <header class="admin-header">
        ...
        <nav>
            <ul class="navigation" id="navigation">
                ...
                <li><a href="manage-files.php" class="active"><i class="fas fa-folder"></i> Files</a></li>
