...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($title) > 200) {
        header("Location: manage-announcements.php?error=Title too long");
        exit;
    }
    if (strlen($content) > 5000) {
        header("Location: manage-announcements.php?error=Content too long");
        exit;
    }
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        if ($_FILES['image']['size'] > 5242880) {
            header("Location: manage-announcements.php?error=Image too large (max 5MB)");
            exit;
        }
        ...
        if (!in_array($_FILES['image']['type'], $allowedTypes)) {
            header("Location: manage-announcements.php?error=Invalid image type");
            exit;
        }
...
if (isset($_GET['delete'])) {
    ...
    header("Location: manage-announcements.php?deleted=1");
    exit;
}
    ...
    <header class="admin-header">
        ...
        <nav>
            <ul class="navigation" id="navigation">
                ...
                <li><a href="manage-announcements.php" class="active"><i class="fas fa-bullhorn"></i> Announcements</a></li>
