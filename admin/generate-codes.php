...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['generate'])) {
    ...
    if ($quantity > 0 && $quantity <= 100) {
        ...
        header("Location: generate-codes.php?success=$generated");
        exit;
    }
}
...
if (isset($_GET['delete'])) {
    ...
    header("Location: generate-codes.php?deleted=1");
    exit;
}
    ...
    <header class="admin-header">
        ...
        <nav>
            <ul class="navigation" id="navigation">
                ...
                <li><a href="generate-codes.php" class="active"><i class="fas fa-ticket-alt"></i> Generate Codes</a></li>
